...
export default function Navbar() {
    ...
    return (
        <nav className="border-b border-green-900 bg-zinc-900 sticky top-0 z-50">
                    ...
                    <div className="hidden sm:ms-6 sm:flex sm:items-center">
                        {user ? (
                                    ...
                                    <Dropdown>
                                        <Dropdown.Trigger>
                                            <span className="inline-flex rounded-md">
                                                <button
                                                    type="button"
                                                    className="inline-flex items-center rounded-md border border-transparent bg-zinc-800 px-3 py-2 text-sm font-medium leading-4 text-zinc-300 transition duration-150 ease-in-out hover:text-white focus:outline-none"
                                                >
                                                    {user.name}
                            ...
                            <div className="flex gap-4">
                                <Link
                                    href={route('login')}
                                    className="text-sm font-mono text-zinc-400 hover:text-green-400 transition-colors"
                                >
                                    Log in
                                </Link>
                                <Link
            ...
            <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                {user ? (
                    ...
                    <div className="space-y-1 pb-3 pt-2 border-t border-zinc-800">
